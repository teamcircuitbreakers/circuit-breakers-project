...
def create_order():
    ...
    try:
        ...
        # ---------------- ADDED LINES START ----------------
        # Extract donor details from frontend request
        donor_name = data.get('name', 'Anonymous')
        donor_contact = data.get('contact', '')
        # ---------------- ADDED LINES END ----------------
        ...
        order_data = {
            ...
            # ---------------- ADDED LINES START ----------------
            # Include donor details inside Razorpay order "notes"
            'notes': {
                'donor_name': donor_name,
                'donor_contact': donor_contact,
                'source': 'Circuit Breakers Donation'
            }
            # ---------------- ADDED LINES END ----------------
        }
